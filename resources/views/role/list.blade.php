    ...
    <div class="block full">
        ...
        @foreach($roles as $role)
            <div class="list-group">
                ...
                <!-- **************分配权限***************-->
                <div class="block">
                    <form action="{{ url('roles/'.$role->id) }}" id="form-{{ $role->id }}" method="post" class="form-horizontal">
                        {{ csrf_field() }}
                        <input type="hidden" name="_method" value="patch">
                        <div class="form-group">
                            <div class="col-md-12">
                                <select id="example-chosen-multiple" name="permissions[]" class="select-chosen" data-placeholder="Choose a Country.." style="width: 250px; display: none;" multiple="">
